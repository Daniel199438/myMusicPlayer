...
import jaudiotagger.org.jaudiotagger.audio.exceptions.CannotReadVideoException;
...
{
    // Logger Object
    public static Logger logger = Logger.getLogger("jaudiotagger.org.jaudiotagger.audio.mp4.atom");
