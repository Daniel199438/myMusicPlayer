...
import jaudiotagger.org.jaudiotagger.tag.id3.framebody.AbstractID3v2FrameBody;
import jaudiotagger.org.jaudiotagger.tag.id3.framebody.FrameBodyDeprecated;
import jaudiotagger.org.jaudiotagger.tag.id3.framebody.FrameBodyUnsupported;
import jaudiotagger.org.jaudiotagger.tag.id3.valuepair.TextEncoding;
import jaudiotagger.org.jaudiotagger.utils.EqualsUtil;
...
public class ID3v22Frame extends AbstractID3v2Frame
{
    ...
    public ID3v22Frame(String identifier)
    {
        ...
        try
        {
            Class<AbstractID3v2FrameBody> c = (Class<AbstractID3v2FrameBody>) Class.forName("jaudiotagger.org.jaudiotagger.tag.id3.framebody.FrameBody" + bodyIdentifier);
     ...
     * @throws jaudiotagger.org.jaudiotagger.tag.InvalidFrameException
     */
