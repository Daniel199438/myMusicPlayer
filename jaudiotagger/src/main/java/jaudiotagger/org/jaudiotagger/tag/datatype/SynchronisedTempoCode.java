 ...
 */
package jaudiotagger.org.jaudiotagger.tag.datatype;

import jaudiotagger.org.jaudiotagger.tag.InvalidDataTypeException;
import jaudiotagger.org.jaudiotagger.tag.id3.AbstractTagFrameBody;
import jaudiotagger.org.jaudiotagger.tag.id3.valuepair.EventTimingTypes;

/**
 * A single synchronized tempo code. Part of a list of temnpo codes ({@link jaudiotagger.org.jaudiotagger.tag.datatype.SynchronisedTempoCodeList}), that are contained in
 * {@link jaudiotagger.org.jaudiotagger.tag.id3.framebody.FrameBodySYTC}
 *
